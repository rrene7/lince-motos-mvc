...
<table>
    <thead><tr><th>Código</th><th>Motocicleta</th><th>Placa</th><th>Unidad</th><th>Kilometraje</th><th>Estado</th><th></th></tr></thead>
    <tbody>
    <?php foreach ($motos as $moto): ?>
        <tr>
            ...
            <td class="actions"><a class="btn btn-small" href="<?= e(base_url('motos/ver?id=' . $moto['id'])) ?>">Ver</a></td>
        </tr>
    <?php endforeach; ?>
    <?php if (!$motos): ?><tr><td colspan="7" class="empty">No se encontraron motocicletas.</td></tr><?php endif; ?>
    </tbody>
</table>
</div>
